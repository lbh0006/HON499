...
public class ApplicationTester {
    ...
    public void testTwoLevels(double outProb1, double ehProb1, 
    ...
    public void initialTestOfProbabilityTree(double outProb, 
                                                    double ehProb, 
                                                    double inProb) 
    {
        Scene rootScene = new Scene("root","This is the root.\n");
    ...
    public void initialTestOfAdvProbabilityTree(double outProb,
                                                       double ehProb,
                                                       double inProb,
